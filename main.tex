...
Large language models (LLMs) are increasingly used in health services research (HSR) to simulate policy effects---generating treatment-effect estimates for administrative burden, access barriers, and behavioral responses \citep{Aher2022,Park2023,Argyle2023,Lin2024}. This creates a new methodological problem: seemingly technical treatment-effect estimates may depend on analyst-selected normative framing. The same model, same synthetic population, and same policy scenario can produce materially different simulated effects depending on which governance-value lens---autonomy, collective obligation, or equity---is activated in the prompt.
...
\begin{center}
\Large\textbf{Online Supplement: ``Validity and Robustness of LLM-Assisted Policy Simulation in Health Services Research: A Value-Sensitivity Audit''}

\large Yichao Jin

\normalsize September 16, 2026
\end{center}

\vspace{1em}
\noindent This Online Supplement contains supporting materials for the main text, organized as follows. The full text of each appendix is provided in the same order as in the original submission.
