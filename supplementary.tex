...
\end{tabular}
\begin{flushleft}
\footnotesize Notes: Each row summarizes coefficients from fifteen leave-one-model-out specifications. The access-barrier and coercive-backlash coefficients are sign-stable across all specifications; collective responsibility is not. The direct PVC coefficient is negative in all fifteen specifications.
\end{flushleft}
\end{table}
