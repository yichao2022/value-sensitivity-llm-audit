...
\textit{SHA256:} \texttt{87d830af5050707398ac768d4e4e5a4e6c334588e417c5aa4a064e2be6781267}
\end{quote}
...
\textit{SHA256 of the template string:} \texttt{a2d059f1a9adba372f3b55dc750c952a2b35daa4da34c19ab0f33ecb07cf0bd3}
\end{quote}
The rendered user prompt inserts the twenty items in the fixed order listed above, each formatted as \texttt{<order>. <item text>}; the resulting prompt has SHA256 \texttt{188a69d76364465098db02fe542d20f016ad40cbd72a70974561ce87ebe3a674}, which is identical for every endpoint. The first two lines of the rendered prompt are:
