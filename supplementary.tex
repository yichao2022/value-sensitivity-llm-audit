...
\end{quote}
The rendered user prompt inserts the twenty items in the fixed order listed above, each formatted as \texttt{<order>. <item text>}; the resulting prompt has SHA256\\
\texttt{188a69d76364465098db02fe542d20f016ad40cbd72a70974561ce87ebe3a674},
which is identical for every endpoint. The first two lines of the rendered prompt are:
...
\begin{itemize}
    ...
    Full system prompt SHA256: \texttt{8b7d948eeee661603aa9898815ee3a01a058f43d4cc878cbc077e6cb5a5df243}
    ...
    Full system prompt SHA256: \texttt{fe7512cde053405edf59cbaaf6d1402f68d69e7c478984eee3d0fbc3a49a5ecb}
    ...
    Full system prompt SHA256: \texttt{cba0156ababefd86611eb267ebf9ccddb1d60fe5a8cecf4e289871006042844a}
\end{itemize}
